...
;layui.define(["layer", "form"], function (t) {
    ...
    var e = layui.$, i = layui.layer, a = layui.form, l = (layui.hint(), layui.device()), n = "layedit",
        o = "layui-show", r = "layui-disabled", c = function () {
            var t = this;
            t.index = 0, t.config = {
                tool: ["strong", "italic", "underline","video", "del", "|", "left", "center", "right", "|", "link", "unlink", "face", "image"],
                hideTool: [],
                height: 280
            }
        };
    ...
    var s = function (t, i, a) {
                ...
                layui.use("upload", function (o) {
                    ...
                    o.render({
                        url: r.url, method: r.type, elem: e(n).find("input")[0], done: function (e) {
                            100 == e.code ? (e.data = e.data || {}, v.call(t, "img", {
                                src: e.data.src,
                                alt: e.data.title
                            }, a)) : i.msg(e.msg || "上传失败")
                        }
        ...
        video:'<i class="layui-icon layedit-tool-video" title="视频通话" lay-command="video" onclick="sendVideo()" id="video" layedit-event="v"">&#xe6ed;</i>',
